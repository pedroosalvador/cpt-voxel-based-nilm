...
try:
    from volumentations import Compose, GaussianNoise
...
def augment_dataset(X, y):
    if Compose is None or GaussianNoise is None:
        raise ImportError(
            "volumentations is required to augment the dataset. "
            "Install it or run without --augment."
        )
